...
- **⚡ AMP Optimized**: These blocks are AMP optimized, considering AMP is one of the most important ranking factors for search engines.
- **🎨 Easy Customization**: The blocks are easy to customize according to your requirements. You can create complex layouts in a very short time.
...
Responsive Blocks plugin is compatible with most of the popular themes available on the WordPress themes repository. Moreover, we have worked extensively to make the integration deeper with our own Cyberchimps Responsive theme.
...
####<strong>Reasons to choose the Responsive WordPress Theme</strong>####
...
= 4. What themes can I use with the Responsive Blocks Plugin? =
You can use all types of themes with Responsive Blocks Plugin.
...
[youtube https://www.youtube.com/watch?v=ALTDNWpp2eI]

To install the Responsive Blocks - WordPress Gutenberg Blocks plugin manually from the WordPress admin dashboard:

<ol>
	<li>Download the latest Responsive Blocks - WordPress Gutenberg Blocks plugin from the WordPress Repository</li>
<li>Login to your WordPress Dashboard</li>
<li>Go to Plugins > Add New</li>
<li>Search for Responsive Blocks - WordPress Gutenberg Blocks</li>
<li>Install the Responsive Blocks - WordPress Gutenberg Blocks plugin</li>
<li>Activate it</li>
</ol>

**FTP Installation**

To install the Responsive Blocks - WordPress Gutenberg Blocks plugin via FTP
<ol>
<li>Download the latest Responsive Blocks - WordPress Gutenberg Blocks plugin zip  from the WordPress repository</li>
<li>Unzip the plugin zip file</li>
<li>Open your WordPress site via FTP. We would recommend you to use FileZilla</li>
<li>From FTP, visit the root of the WordPress install</li>
<li>Now visit wp-content folder > plugins</li>
<li>Upload the plugin unzipped file as shown in step 2</li>
</ol>
...
= 2.2.2 - 20th February 2026 =
* Fix – Pricing Table Block: Removed redundant bottom spacing control from the Spacing panel.
* Fix – Pricing Table Block: Resolved block overlapping issue with the next block in the editor.
* Fix – Removed PCP errors to improve overall stability.
* Fix – Enhanced Security – Strengthened the codebase to further protect your website.

= 2.2.1 - 11th February 2026 =
* Fix – Fixed an issue related to unintended email behavior in Form Block.
...
* Improvement – Added a global setting to enable or disable the Template Library button in the block editor.
* Fix – Table of Contents block: bug fix.
...
= 2.1.3 - 9th October 2025 =
* New - Display Conditions.
* Improvement - Improved the UI and functional issues in the block inspector.

= 2.1.2 - 29th September 2025 =
* New - Animations Support: Introduced animations across blocks for improved interactivity and design flexibility.
* New - Attempt Block Recovery Toggle: New option in plugin settings to enable/disable automatic block recovery.
...
* Fix - Testimonial Slider block - Fixed arrow buttons in editor.
* Fix - Count Up and Count Down block - Fixed number not moving in editor.
* Fix - Popup block - Fixed minor issues.
* Fix - Image Boxes block - Fixed minor issues.
* Fix - Fixed the 'Back' link not working in template editing issue.
* Fix - Fixed PHP warnings.
* Fix - Enhanced Security: Strengthened the codebase to further protect your website.

= 1.9.9 - 31st December 2024 =
* Improvement - Minor UI Changes.
* Improvement - Added the 'Default' option for the typography's Font Family setting across all blocks.
* Fix - Fixed styles not being applied to the Form Block > Tablet and Mobile Preview.

= 1.9.8 - 16th December 2024 =
* Improvement - Improved UI for Typography controls across all blocks.
...
* Improvement - Improved UI for Typography controls in Testimonial block.
* Improvement - Improved UI for Box Shadow controls in Testimonial block.
* Improvement - Improved UI for Image controls in Testimonial block.
* Improvement - Improved UI for List Alignment in Icon List block.
* Improvement - Improved UI for Icon and Label in Icon List Child block.
* Improvement - Improved UI for Separator in Advanced Heading block.
* Fix - Fix assets loading issue for non-FSE theme.
...
= 1.8.5 - 9th July 2024 =
* New - Introduced new padding and margin control in few blocks.
...
= 1.7.6 - 18th December 2023 =
* Fix - Advanced Columns Block - Column width issue for decimal value.
* Fix - Minor bug fixes.

= 1.7.5 - 6th December 2023 =
* New - Image Block
...
* Fix - Fixed PHP Deprecated warnings.
...
= 1.6.8 - 13th march 2023 =
* Fix: Fix Attempt Block Recovery issue in some blocks.
...
* Fix - Team Block - Extra space is added below social icons
* Fix - Section Block - margin and padding is not working when set to 0

= 1.5.4 - 27th January 2022 =
...
* New - Feature to import pre-designed Gutenberg sections and pages for the Responsive Blocks - WordPress Gutenberg Blocks.
